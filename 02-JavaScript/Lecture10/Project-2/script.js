...
products.forEach((product) => {
  ...
  discount.style.backgroundColor = '#ff6b6b';
  discount.style.color = 'white';
  discount.style.padding = '4px 4px';
  ...
  if(product.inStock == false) {
    ...
    stock.style.top = '10px';
    stock.style.right = '10px';
    stock.style.backgroundColor = 'rgba(0, 0, 0, 0.8)';
    stock.style.color = '#ff4d4d';
    stock.style.padding = '4px 4px';
    stock.style.borderRadius = '4px';
    stock.style.fontSize = '12px';
    stock.style.fontWeight = 'bold';
    stock.style.margin = '0';
  }

  imageContainer.append(image, discount, stock);
  ...
  firstRow.append(title, rating);

  const brand = document.createElement('h3');
  brand.textContent = product.brand;
  brand.style.fontSize = '14px';
  brand.style.color = '#aaa';
  ...
  productCard.style.border = '1px solid #333';
  productCard.style.borderRadius = '10px';
  productCard.style.padding = '10px';
  productCard.style.width = '250px';     
  productCard.style.backgroundColor = '#111';
  productCard.append(imageContainer, firstRow, secondRow, category);
